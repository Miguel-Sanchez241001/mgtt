...
public class PersistenciaConfig {
	...
	public static final String MAPPERS_PACKAGE_SATE_1 = "pe.bn.com.mgtt.persistence.mapper.internal";
	
	public static final String MAPPERS_PACKAGE_SATE_2 = "pe.bn.com.mgtt.persistence.mapper.external";
	...
	public SqlSessionFactory sqlSessionFactorySate() throws Exception {
		...
		sessionFactory.setTypeAliasesPackage("pe.bn.com.mgtt.transversal.dto.sate");
	...
	public SqlSessionFactory sqlSessionFactorySarasign() throws Exception {
		...
		sessionFactory.setTypeAliasesPackage("pe.bn.com.mgtt.transversal.dto.tablas");
		SqlSessionFactory sqlSessionFactory = sessionFactory.getObject();
		sqlSessionFactory.getConfiguration().setJdbcTypeForNull(JdbcType.NULL);
		return sqlSessionFactory;
	}
